...
class segmentat_001_wire(Layer_06):
    ...
    def __init__(self,
        ...
        self.atrous_pyramid_00 = atrous_pyramid_00(num_filteres_in , num_filteres_out ,num_filteres_middle, self.L1, self.L2, self.device,self.show)
       
        self.atrous_pyramid_01 = atrous_pyramid_00(self.dict_layers['atrous_pyramid_01'][0],
                                                   self.dict_layers['atrous_pyramid_01'][1],
                                                   self.dict_layers['atrous_pyramid_01'][2],
                                                   self.L1, self.L2, self.device,self.show)

        self.atrous_pyramid_02 = atrous_pyramid_00(self.dict_layers['atrous_pyramid_02'][0],
        ...
        self.add_module('fully_conn_layer_universal_00', fully_conn_layer_universal_00([624,128,128,64,64,64], 'sigmoid', self.device))
        ...
        self.add_module('fun_of_factor_00',fun_of_factor_00(32, 24, 12, 12, 12, 3, 'sigmoid', self.device)) 
        ...
        self.conv_layer_universal_01_downsampl=conv_layer_downsample_01(self.dict_layers['conv_layer_DS_01'][0],
                                                                        self.dict_layers['conv_layer_DS_01'][1],
                                                                        True, self.L1, self.L2, self.device) 

        self.conv_layer_universal_02_downsampl=conv_layer_downsample_01(self.dict_layers['conv_layer_DS_02'][0],
                                                                        self.dict_layers['conv_layer_DS_02'][1],
                                                                        True, self.L1, self.L2, self.device) 

        self.conv_layer_universal_03_downsampl=conv_layer_downsample_01(self.dict_layers['conv_layer_DS_03'][0],
                                                                        self.dict_layers['conv_layer_DS_03'][1],
                                                                        True, self.L1, self.L2, self.device)  

        self.conv_layer_universal_04_downsampl=conv_layer_downsample_01(self.dict_layers['conv_layer_DS_04'][0],
                                                                        self.dict_layers['conv_layer_DS_04'][1],
                                                                        True, self.L1, self.L2, self.device) 

        # Четыре ДеКонволюционных слоя с уменьшением каналов изображения
        self.conv_layer_universal_01_upsampl=conv_layer_universal_upsample_00(self.dict_layers['conv_layer_UP_01'][0],
                                                                              self.dict_layers['conv_layer_UP_01'][1],
                                                                              self.dict_layers['conv_layer_UP_01'][2],
                                                                              True, self.L1, self.L2, self.device)   

        self.conv_layer_universal_02_upsampl=conv_layer_universal_upsample_00(self.dict_layers['conv_layer_UP_02'][0],
                                                                              self.dict_layers['conv_layer_UP_02'][1],
                                                                              self.dict_layers['conv_layer_UP_02'][2],
                                                                              True, self.L1, self.L2, self.device)  

        self.conv_layer_universal_03_upsampl=conv_layer_universal_upsample_00(self.dict_layers['conv_layer_UP_03'][0],
                                                                              self.dict_layers['conv_layer_UP_03'][1],
                                                                              self.dict_layers['conv_layer_UP_03'][2],
                                                                              True, self.L1, self.L2, self.device)   

        self.conv_layer_universal_04_upsampl=conv_layer_universal_upsample_00(self.dict_layers['conv_layer_UP_04'][0],
        ...
        self.encoder_00_upsampl=conv_layer_universal_upsample_00(self.dict_layers['conv_layer_encoder_01'][0],
        ...
        _encoder_map=conv_layer_downsample_01(self.dict_layers['encoder_map_01'][0],
